...
namespace SteganoBlaze.Tests
{
    ...
    public class AudioEncoderTests : AudioSteganography
    {
        ...
        public void Encode_ShouldEncodeBytesOnSelectedBits(SampleParameters testSampleParameters)
        {
            ...
            for (var i = 0;
                 i < expected.Length - Carrier.GetTotalSampleCount() * testSampleParameters.SampleBitsToUse % 8;
                 i++) expected[i] = (byte)(255 - (Math.Pow(2, testSampleParameters.SampleBitsToUse) - 1));
