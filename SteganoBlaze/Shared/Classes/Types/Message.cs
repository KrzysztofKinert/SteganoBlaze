...
namespace SteganoBlaze.Shared.Classes.Types
{
    public class Message
    {
        ...
        public Message(File file)
        {
            ...
            string metadataString = "!fnS!" + fileName + "!fnE!" + "!ctS!" + contentType + "!ctE!" + "!fsS!" + fileData.Length + "!fsE!" + "!cpS!" + compressed + "!cpE!";
			...
			messageSize = header.Length + metadata.Length + fileData.Length;
        }
